...
import {
  ...
  Bell, Settings, HelpCircle, Maximize2, Shield, FileText,
...
const SimpleMenu = () => {
  ...
  const APP: MenuLink[] = [
    ...
    { icon: Shield,      label: 'Gizlilik Politikası', color: 'bg-emerald-500/10 text-emerald-500', action: () => window.open('https://gokhanatar.github.io/Kredy-Finans-Yonetimi/privacy-policy.html', '_blank') },
    { icon: FileText,    label: 'Kullanım Koşulları',  color: 'bg-teal-500/10 text-teal-500', action: () => window.open('https://gokhanatar.github.io/Kredy-Finans-Yonetimi/terms-of-use.html', '_blank') },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <motion.main
        className="page-container py-4 pb-safe-nav lg:pb-6 space-y-5"
